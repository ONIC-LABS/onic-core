...
import {
  ...
  OnicRunOptions,
  OnicRunOutput,
} from "@/agents/onic/types.js";
import { GetRunContext } from "@/context.js";
import { assign } from "@/internals/helpers/object.js";
import * as R from "remeda";
import { BaseRunner } from "@/agents/onic/runners/base.js";
import { GraniteRunner } from "@/agents/onic/runners/granite/runner.js";
import { DefaultRunner } from "@/agents/onic/runners/default/runner.js";
import { ValueError } from "@/errors.js";

export interface OnicInput {
  llm: ChatLLM<ChatLLMOutput>;
  tools: AnyTool[];
  memory: BaseMemory;
  meta?: Omit<AgentMeta, "tools">;
  templates?: Partial<OnicAgentTemplates>;
}

export class OnicAgent extends BaseAgent<OnicRunInput, OnicRunOutput, OnicRunOptions> {
  public readonly emitter = Emitter.root.child<OnicCallbacks>({
    namespace: ["agent", "onic"],
    creator: this,
  });

  protected runner: new (...args: ConstructorParameters<typeof BaseRunner>) => BaseRunner;

  constructor(protected readonly input: OnicInput) {
    super();
  ...
  get meta(): AgentMeta {
    ...
    return {
      ...
      tools,
      description:
        "The Onic framework demonstrates its ability to auto-correct and adapt in real-time, improving the overall reliability and resilience of the system.",
      ...(tools.length > 0 && {
        extraDescription: [
  ...
  protected async _run(
    input: OnicRunInput,
    options: OnicRunOptions = {},
    run: GetRunContext<typeof this>,
  ): Promise<OnicRunOutput> {
