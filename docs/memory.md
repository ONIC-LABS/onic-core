...
> [!TIP]
>
> Location within the framework `onic-agent-framework/memory`.
...
> [!NOTE]
>
> onic Agent internally uses `TokenMemory` to store intermediate steps for a given run.
...
```ts
import { SlidingMemory } from "onic-agent-framework/memory/slidingMemory";
import { BaseMessage } from "onic-agent-framework/llms/primitives/message";
...
```ts
import { BaseMessage } from "onic-agent-framework/llms/primitives/message";
import { SummarizeMemory } from "onic-agent-framework/memory/summarizeMemory";
import { OllamaChatLLM } from "onic-agent-framework/adapters/ollama/chat";
...
```ts
import { BaseMemory } from "onic-agent-framework/memory/base";
import { BaseMessage } from "onic-agent-framework/llms/primitives/message";
