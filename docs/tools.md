...
> [!TIP]
>
> Location within the framework `onic-agent-framework/tools`.
...
import { ArXivTool } from "onic-agent-framework/tools/arxiv";
...
} from "onic-agent-framework/tools/base";
import { z } from "zod";
...
import { z } from "zod";
import { createURLParams } from "onic-agent-framework/internals/fetcher";
import { GetRunContext } from "onic-agent-framework/context";
import { Callback, Emitter } from "onic-agent-framework/emitter/emitter";
...
```ts
import { DynamicTool, StringToolOutput } from "onic-agent-framework/tools/base";
import { z } from "zod";
...
import { CustomTool } from "onic-agent-framework/tools/custom";
