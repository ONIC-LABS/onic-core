...
> [!TIP]
>
> 🚀 Would you like a fully set-up TypeScript project with onic, Code Interpreter, and Observability? Check out our [onic Framework Starter](https://github.com/i-am-onic/onic-agent-framework-starter).
